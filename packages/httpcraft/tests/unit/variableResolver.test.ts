...
} from '../../src/core/variableResolver.js';
...
describe('VariableResolver', () => {
  ...
  describe('T3.2: Environment variable support', () => {
    ...
    it('should resolve multiple environment variables', async () => {
      const result = await resolver.resolve(
        'User: {{env.USER}}, Env: {{env.NODE_ENV}}',
        mockContext
      );
    ...
    it('should throw error for undefined environment variables', async () => {
      await expect(resolver.resolve('Missing: {{env.UNDEFINED_VAR}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );
  ...
  describe('T3.7: Error handling for unresolved variables', () => {
    it('should throw VariableResolutionError for undefined variables', async () => {
      await expect(resolver.resolve('Missing: {{undefinedVar}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );
    });
    ...
    it('should provide informative error message', async () => {
      try {
        ...
        expect((error as VariableResolutionError).message).toBe(
          "Variable 'undefinedVar' could not be resolved"
        );
  ...
  describe('Phase 3 Compatibility - Basic Functionality', () => {
    ...
    it('should throw error for undefined variables', async () => {
      ...
      await expect(resolver.resolve('{{undefined_var}}', context)).rejects.toThrow(
        VariableResolutionError
      );
    });
  });
  ...
  describe('Phase 4 - Profile Variables', () => {
    it('should resolve profile variables with profile. prefix', async () => {
      ...
      const result = await resolver.resolve(
        'Host: {{profile.apiHost}}, User: {{profile.userId}}',
        context
      );
    ...
    it('should throw error for undefined profile variables', async () => {
      ...
      await expect(resolver.resolve('{{profile.missing}}', context)).rejects.toThrow(
        VariableResolutionError
      );
    });
  });
  ...
  describe('Phase 4 - API and Endpoint Variables', () => {
    it('should resolve API variables with api. prefix', async () => {
      ...
      const result = await resolver.resolve(
        'Version: {{api.version}}, Timeout: {{api.timeout}}',
        context
      );
    ...
    it('should resolve endpoint variables with endpoint. prefix', async () => {
      ...
      const result = await resolver.resolve(
        'Max: {{endpoint.maxItems}}, Include: {{endpoint.includeDeleted}}',
        context
      );
    ...
    it('should throw error for undefined API variables', async () => {
      ...
      await expect(resolver.resolve('{{api.missing}}', context)).rejects.toThrow(
        VariableResolutionError
      );
    });
    ...
    it('should throw error for undefined endpoint variables', async () => {
      ...
      await expect(resolver.resolve('{{endpoint.missing}}', context)).rejects.toThrow(
        VariableResolutionError
      );
    });
  });
  ...
  describe('Phase 4 - Scoped Variables', () => {
    it('should resolve scoped variables correctly', async () => {
      ...
      const template =
        'CLI: {{cliVar}}, Profile: {{profile.profileVar}}, API: {{api.apiVar}}, Endpoint: {{endpoint.endpointVar}}, Env: {{env.ENV_VAR}}';
      const result = await resolver.resolve(template, context);
      expect(result).toBe(
        'CLI: cli_val, Profile: profile_val, API: api_val, Endpoint: endpoint_val, Env: env_val'
      );
    });
    ...
    it('should throw error for unknown scopes', async () => {
      ...
      await expect(resolver.resolve('{{unknown.variable}}', context)).rejects.toThrow(
        VariableResolutionError
      );
    });
  });
  ...
  describe('Data Type Handling', () => {
    it('should stringify numbers correctly', async () => {
      ...
      const result = await resolver.resolve(
        'Port: {{profile.port}}, Version: {{profile.version}}',
        context
      );
    ...
    it('should stringify booleans correctly', async () => {
      ...
      const result = await resolver.resolve(
        'Debug: {{profile.debug}}, Prod: {{profile.production}}',
        context
      );
  ...
  describe('Edge Cases', () => {
    it('should handle empty variable names gracefully', async () => {
      ...
      await expect(resolver.resolve('{{}}', context)).rejects.toThrow(VariableResolutionError);
    });
  ...
  describe('T8.8 & T8.9: Step Variable Resolution', () => {
    ...
    describe('T8.8: Response variable resolution', () => {
      it('should resolve step response body using JSONPath', async () => {
        const result = await resolver.resolve(
          'User ID: {{steps.createUser.response.body.id}}',
          mockContext
        );
      ...
      it('should resolve step response status', async () => {
        const result = await resolver.resolve(
          'Status: {{steps.createUser.response.status}}',
          mockContext
        );
      ...
      it('should resolve step response headers', async () => {
        const result = await resolver.resolve(
          'Location: {{steps.createUser.response.headers.location}}',
          mockContext
        );
      ...
      it('should resolve nested JSON properties from response body', async () => {
        const result = await resolver.resolve(
          'Name: {{steps.getUser.response.body.name}}',
          mockContext
        );
      ...
      it('should resolve entire response object when no path specified', async () => {
        const result = await resolver.resolve(
          'Response: {{steps.createUser.response}}',
          mockContext
        );
    ...
    describe('T8.9: Request variable resolution', () => {
      it('should resolve step request method', async () => {
        const result = await resolver.resolve(
          'Method: {{steps.createUser.request.method}}',
          mockContext
        );
      ...
      it('should resolve step request headers', async () => {
        const result = await resolver.resolve(
          'Content-Type: {{steps.createUser.request.headers.Content-Type}}',
          mockContext
        );
      ...
      it('should resolve step request body properties', async () => {
        const result = await resolver.resolve(
          'Email: {{steps.createUser.request.body.email}}',
          mockContext
        );
    ...
    describe('Error handling for step variables', () => {
      it('should throw error for non-existent step ID', async () => {
        await expect(
          resolver.resolve('{{steps.nonExistentStep.response.body}}', mockContext)
        ).rejects.toThrow(VariableResolutionError);
      ...
      it('should throw error for invalid data type', async () => {
        await expect(
          resolver.resolve('{{steps.createUser.invalidType.body}}', mockContext)
        ).rejects.toThrow(VariableResolutionError);
      ...
      it('should throw error for invalid step variable format', async () => {
        await expect(resolver.resolve('{{steps.createUser}}', mockContext)).rejects.toThrow(
          VariableResolutionError
        );

        await expect(resolver.resolve('{{steps.createUser}}', mockContext)).rejects.toThrow(
          'Invalid step variable format'
        );
      });
      ...
      it('should throw error when no steps in context', async () => {
        ...
        await expect(
          resolver.resolve('{{steps.createUser.response.body}}', contextWithoutSteps)
        ).rejects.toThrow(VariableResolutionError);

        await expect(
          resolver.resolve('{{steps.createUser.response.body}}', contextWithoutSteps)
        ).rejects.toThrow(
          "Step variable 'steps.createUser.response.body' is not available (no steps in context)"
        );
      });

      it('should throw error for non-existent JSONPath', async () => {
        await expect(
          resolver.resolve('{{steps.createUser.response.body.nonExistentField}}', mockContext)
        ).rejects.toThrow(VariableResolutionError);
    ...
    describe('Complex JSONPath expressions', () => {
      it('should handle array access in JSONPath', async () => {
        ...
        const result = await resolver.resolve(
          'First user: {{steps.getUsers.response.body[0].name}}',
          contextWithArray
        );
      ...
      it('should handle nested object access', async () => {
        ...
        const result = await resolver.resolve(
          'City: {{steps.getProfile.response.body.user.profile.address.city}}',
          contextWithNested
        );
  ...
  describe('T9.4: Secret Variable Resolution', () => {
    ...
    it('should resolve multiple secret variables', async () => {
      ...
      const result = await resolver.resolve(
        'API: {{secret.API_KEY}}, DB: {{secret.DB_PASSWORD}}',
        contextWithSecrets
      );
    ...
    it('should throw error for undefined secret variables', async () => {
      await expect(
        resolver.resolve('Missing: {{secret.UNDEFINED_SECRET}}', mockContext)
      ).rejects.toThrow(VariableResolutionError);
    ...
    it('should differentiate between secret and env variables in error messages', async () => {
      try {
        ...
        expect(error).toBeInstanceOf(VariableResolutionError);
        expect((error as VariableResolutionError).message).toBe(
          "Secret variable 'MISSING_VAR' is not defined"
        );
  ...
  describe('T9.6: Built-in Dynamic Variables', () => {
    ...
    it('should support $randomInt with range parameters', async () => {
      ...
      await expect(resolver.resolve('{{$randomInt(5,5)}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );

      // Test invalid format: min > max (should throw error)
      await expect(resolver.resolve('{{$randomInt(10,5)}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );

      // Test invalid format: non-numeric parameters
      await expect(resolver.resolve('{{$randomInt(a,b)}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );

      // Test invalid format: missing parameters
      await expect(resolver.resolve('{{$randomInt()}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );

      // Test invalid format: single parameter
      await expect(resolver.resolve('{{$randomInt(5)}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );
    });
    ...
    it('should throw error for unknown dynamic variables', async () => {
      await expect(resolver.resolve('{{$unknown}}', mockContext)).rejects.toThrow(
        VariableResolutionError
      );

      await expect(resolver.resolve('{{$invalidVar}}', mockContext)).rejects.toThrow(
        "Unknown dynamic variable '$invalidVar'"
      );
    });
  ...
  describe('T9.5: Secret Masking in Verbose/Dry-Run Output', () => {
    ...
    it('should mask secret values in output strings', async () => {
      ...
      const outputWithSecrets =
        'Headers: Authorization: Bearer secret-api-key-123, X-Token: secret-token-456';
    ...
    it('should handle multiple occurrences of the same secret', async () => {
      ...
      const outputWithRepeatedSecret =
        'Key1: repeated-secret-key, Key2: repeated-secret-key, Key3: repeated-secret-key';
  ...
  describe('T10.16: Nested Variable Resolution', () => {
    ...
    it('should resolve nested variables in step JSONPath expressions', async () => {
      ...
      const context = resolver.createContext({ claimIndex: '1' }, {}, {}, {}, undefined, {});
      context.steps = mockSteps;

      const result = await resolver.resolve(
        '{{steps.getClaims.response.body.data.{{claimIndex}}.id}}',
        context
      );
    ...
    it('should resolve nested variables with different scopes', async () => {
      ...
      const result = await resolver.resolve(
        '{{profile.environment}}/users/{{userId}}/data',
        context
      );
    ...
    it('should resolve complex nested variable expressions', async () => {
      ...
      const result = await resolver.resolve(
        '{{steps.getUsers.response.body.users.{{userIndex}}.posts.{{postIndex}}.title}}',
        context
      );
    ...
    it('should handle environment variables in nested expressions', async () => {
      ...
      const context = resolver.createContext({}, {}, {}, {}, undefined, {});
      context.steps = mockSteps;

      const result = await resolver.resolve(
        '{{steps.getData.response.body.items.{{env.TEST_INDEX}}}}',
        context
      );
    ...
    it('should resolve profile variables in nested expressions', async () => {
      ...
      const result = await resolver.resolve(
        '{{steps.getProducts.response.body.categories.{{profile.category}}.{{profile.productIndex}}}}',
        context
      );
    ...
    it('should prevent infinite loops with circular references', async () => {
      ...
      await expect(resolver.resolve('{{a}}', context)).rejects.toThrow(VariableResolutionError);

      await expect(resolver.resolve('{{a}}', context)).rejects.toThrow(
        'Maximum variable resolution iterations reached'
      );
    });
    ...
    it('should throw error when nested variable cannot be resolved', async () => {
      const context = resolver.createContext({ index: '1' }, {}, {}, {}, undefined, {});

      await expect(resolver.resolve('data.{{undefinedVar}}.value', context)).rejects.toThrow(
        VariableResolutionError
      );
    ...
    it('should work with dynamic variables in nested expressions', async () => {
      const context = resolver.createContext({ prefix: '$timestamp' }, {}, {}, {}, undefined, {});
    ...
    it('should handle multiple levels of nesting', async () => {
      ...
      const result = await resolver.resolve(
        '{{steps.complexData.response.body.data.{{arrayIndex}}.{{objectKey}}}}',
        context
      );
  ...
  describe('Phase 13: Enhanced Profile Merging', () => {
    describe('mergeProfiles with verbose output', () => {
      ...
      it('should show correct profile origin for overridden variables', () => {
        ...
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   setting: override-value (from override profile)\n'
        );
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   unique: base-unique (from base profile)\n'
        );
      });
      ...
      it('should handle complex variable values in verbose output', () => {
        ...
        expect(stderrSpy).toHaveBeenCalledWith('[VERBOSE] Merged profile variables:\n');
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   stringValue: simple string (from complex profile)\n'
        );
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   numberValue: 42 (from complex profile)\n'
        );
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   booleanValue: true (from complex profile)\n'
        );
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   objectValue: [object Object] (from complex profile)\n'
        );
        expect(stderrSpy).toHaveBeenCalledWith(
          '[VERBOSE]   arrayValue: 1,2,3 (from complex profile)\n'
        );
